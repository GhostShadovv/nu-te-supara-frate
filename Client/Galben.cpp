...
//---------------------------------------------------------------------------
 ...
 Galben :: Galben (TPanel *panel,  TPoint point):Pozitie(panel){
...
//---------------------------------------------------------------------------
 ...
 void Galben :: Initializeaza_prima_piesa(TPoint point){
      if (point.x==Locatie[1].x && point.y == Locatie[1].y){// daca am mutat pe prima pozitie
...
//---------------------------------------------------------------------------
 ...
 void Galben :: scoateDin_Casa(TPoint point, bool *marcheazaZar, TButton *aux0, int identificator){
         iesCasa(point, marcheazaZar);
         fJoc->tura_G++;
